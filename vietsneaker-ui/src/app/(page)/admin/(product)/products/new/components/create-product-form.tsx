    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <fieldset className="fieldset w-full p-4 rounded-box space-y-4">
        ...
        <div className="text-right">
          <button className="btn rounded-none border-none bg-[#e20000] hover:bg-[#c10000] text-white font-semibold px-6 py-2 transition-all duration-200 hover:-translate-y-[1px]">Lưu</button>
        </div>
      </fieldset>
    </form>
  );
