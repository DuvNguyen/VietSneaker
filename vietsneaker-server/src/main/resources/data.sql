...
VALUES 
('Nike Air Force 1', 'Giày sneaker huyền thoại của Nike – hàng 2hand chính hãng, vân đế gần full, form giữ chuẩn, upper đẹp như mới, chỉ vài vết sử dụng nhẹ.', 'http://localhost:3000/images/products/nike_air_force_1.png', 700000, 950000, 'Casual', '40.5', 50, 1, 1, 1, 0),
('Adidas Ultraboost 22', 'Giày chạy bộ hiệu năng cao của Adidas – hàng 2hand, đế vẫn còn bám tốt, form chưa xẹp, upper còn rất đẹp.', 'http://localhost:3000/images/products/adidas_ultraboost_22.png', 1800000, 2500000, 'Running', '36', 30, 2, 1, 1, 0),
('Puma Suede Classic', 'Thiết kế retro đường phố của Puma – hàng 2hand chính hãng, vân đế rõ nét, form vẫn giữ tốt, suede chỉ vài vết sử dụng nhỏ.', 'http://localhost:3000/images/products/puma_suede_classic.png', 800000, 1200000, 'Lifestyle', '40', 40, 3, 1, 1, 0),
('Converse Chuck Taylor 70s', 'Mẫu giày canvas cổ điển – hàng 2hand, form ổn, đế chưa mòn nhiều, vải và đế giữ rất tốt.', 'http://localhost:3000/images/products/converse_chuck_70.png', 650000, 950000, 'Casual', '36.5', 60, 4, 1, 1, 0),
('Vans Old Skool', 'Sneaker skate nổi tiếng – hàng 2hand chính hãng, đế hơi ngả màu theo thời gian nhưng form vẫn chuẩn, upper còn đẹp.', 'http://localhost:3000/images/products/vans_old_skool.png', 600000, 850000, 'Skate', '37', 55, 5, 1, 1, 0),
('New Balance 550', 'Phong cách retro basketball của NB – hàng 2hand, mid-sole còn dày, upper chỉ hơi nhăn, form vẫn chắc.', 'http://localhost:3000/images/products/new_balance_550.png', 1200000, 1800000, 'Lifestyle', '40.5', 25, 6, 1, 1, 0),
('Reebok Classic Leather', 'Phong cách vintage từ thập niên 80 – hàng 2hand, da upper giữ tốt, chỉ có vết gấp nhỏ ở mũi, form vẫn đẹp.', 'http://localhost:3000/images/products/reebok_classic.png', 900000, 1350000, 'Lifestyle', '40', 35, 7, 1, 1, 0),
('ASICS Gel-Kayano 29', 'Giày chạy bộ bền bỉ – hàng 2hand, đế chưa bị sờn, form chưa xẹp, chỉ có vài vết nhỏ, cực hợp tập hoặc đi bộ.', 'http://localhost:3000/images/products/asics_kayano.png', 1500000, 2200000, 'Running', '38', 20, 8, 1, 1, 0),
('Fila Disruptor II', 'Thiết kế chunky hầm hố Streetwear – hàng 2hand chính hãng, đế vẫn cao rõ, upper còn đẹp, form giữ tốt.', 'http://localhost:3000/images/products/fila_disruptor.png', 700000, 1100000, 'Streetwear', '40', 30, 9, 1, 1, 0),
('Under Armour Curry Flow 10', 'Giày bóng rổ của Stephen Curry – hàng 2hand, độ mòn đế thấp, form vẫn rất đẹp, phù hợp chơi bóng hoặc diện hàng ngày.', 'http://localhost:3000/images/products/ua_curry_10.png', 1800000, 2600000, 'Basketball', '44', 15, 10, 1, 1, 0);
